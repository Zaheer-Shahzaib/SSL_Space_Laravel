...
<body id="features-page">
        ...
        <div class="row">
            <div class="main-sec">
                <div class="main-text-sec">
                    <h1 class="heading-text" style="color: #000000;" data-aos="fade-right">
                        Premium Co-working Spaces &
                    </h1>
                    <h1 class="heading-text" style="color:#999999;" data-aos="fade-left">
                        Shared Offices in Lahore.
                    </h1>
                    <h1 class="heading-text" style=" white-space: nowrap;" data-aos="fade-right">
    ...
    <div class="container-fluid">
        <div class="row p-5" style="border-top: 1px solid #f6f6f6;">
            <div class="col-lg-4 col-md-4 col-sm-12 pb-2">
                <div class="tick-text" data-aos="zoom-in">
                    <img class="tick-main" src="images/tick.png" alt="">
    ...
    <div class="container-fluid" data-aos="zoom-in">
        <div class="pt-2 mb-5">
            <div id="imageSlider" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner" style="height: 418px;">
                    <div class="carousel-item active">
                        <img src="{{asset('images/image edit 2.jpg')}}">
                    </div>
                    <div class="carousel-item">
                        <img src="{{asset('images/image edit 3.jpg')}}" alt="Slide 2" class="d-block w-100">
                    </div>
                    <div class="carousel-item">
                        <img src="{{asset('images/image edit 4.jpg')}}">
                    </div>
                    <div class="carousel-item">
                        <img src="{{asset('images/image edit 3.jpg')}}" alt="Slide 3" class="d-block w-100">
                    </div>
                </div>
    ...
    <div class="container">
        <div class="mt-5">
            <div class="second-text-sec">
                <h1 class="sec-heading-text" style="color: #000000;" data-aos="fade-right">
                    Discover the perfect blend of flexibility and functionality with our curated packages.
                    Explore
                    <a href="{{route('pricing')}}" class="animated-text">
        ...
        <div class="row text-center pt-5">
            <div class="col-lg-2.4 col-md-4 col-sm-6 mb-4" data-aos="zoom-in">
                <a href="{{route('pricing')}}" style="text-decoration: none; color:#000000;">
                    <div class="card zoom m-3">
        ...
        <div class="row pt-5" data-aos="zoom-in">
        ...
        <div class="row pb-5 p-0" data-aos="zoom-in">
            <div class="col-lg-2 col-sm-4 col-4">
    ...
    <div class="container-fluid">
        <div class="row p-5" style="background: #151414;">
            <div class="second-text-sec">
                <h1 class="sec-heading-text" style="color: #ffffff;" data-aos="fade-right">
    ...
    <div class="container">
        <div class="p-3 text-center" data-aos="zoom-in">
            <h1 style="font-size: 48px;"><b>FAQs</b></h1>
            <p class="fs-4">
                <b class="faq-text">
        ...
        <div class="row mt-5 mb-5 bg-light" style="border-radius: 20px; box-shadow: 0px 0px 10px 5px rgba(0,0,0,0.123);" data-aos="zoom-in">
            <div class="col-lg-6 p-4">
                <p class="last-text-main">We are keeping you safe <br> during COVID-19.
                    <b style="color: #2ca8dd;"> A small <br> distance makes a great
                        difference:
                    </b>
                </p>
            </div>
            <div class="col-lg-6">
                <ul style="padding: 40px;font-size: 20px;">
